%Copyrighted by Pijus Simonaits, 2010, 2011. Some rights reserved.
...
\begin{enumerate}
  ...
  \item Turime stačiakampį gretasienį $a\times b\times c$, $a,b,c \in \N$,
    ...
    %Tad sąryšis, kurį turi tenkinti $a$, $b$ ir $c$ yra $a\oplus b\ oplus
  ...
  \item \text{[Misere NIM]} Žaidžiamas NIM, bet pralaimi tas, kuris atlieka
    ...
    %yra vienetinės krūvelės (turinčios vieną akmenuką). Žaidimas
    %žaidžiamas lygiai taip pat kaip normalus NIM iki to momento, kai
    %laiminčiojo žaidėjo ėjimas gali ant stalo palikti tik nelyginį skaičių
    %vienetinių krūvelių (jokių kitų), tada jis atlieka šį ėjimą ir laimi
    %žaidimą. 
\end{enumerate}
